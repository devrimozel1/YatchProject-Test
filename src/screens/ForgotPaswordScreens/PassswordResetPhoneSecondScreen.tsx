...
import ResetPhoneImage from "../../logos/ResetPhone.png"
import { useNavigation } from '@react-navigation/native'

function PassswordResetPhoneSecondScreen() {
    ...
    return (
        <GeneralView>
            <MailImageView>
                <Image source={ResetPhoneImage} />
            </MailImageView>
            <TextView>
                <Text style={{ fontSize: 15, fontWeight: "medium", color: "#000", alignItems: "center", justifyContent: "center", textAlign: "center" }}>Lütfen telefonunuza(+90 53********) gelen doğrulama kodunu aşağıdaki alana giriniz.</Text>
            </TextView>
            <OtpBarView>
                <OtpBarBox></OtpBarBox>
                <OtpBarBox></OtpBarBox>
...
export default PassswordResetPhoneSecondScreen
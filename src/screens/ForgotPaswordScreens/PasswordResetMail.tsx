...
function PasswordResetMail() {
  ...
  const handleContinue = () => {
    navigation.reset({
      index: 0,
      routes: [{ name: "ResetMailSecond" as never }]
    })
  }
  ...
  return (
    <GeneralView>
      ...
      <ForgotPasswordTextView>
        <Text style={{ color: "black", fontSize: 15, fontWeight: "400", fontFamily: "urbanist", textAlign: "center" }}>Şifre yenileme bağlantısını gönderebilmemiz için e-posta adresinize ihtiyacımız var.</Text>
      </ForgotPasswordTextView>
      <ForgotMailBox>
        <Text style={{ color: "#1366B2", fontSize: 15, fontWeight: "400", fontFamily: "urbanist", textAlign: "left",}}>E-Posta Adresiniz</Text>
        <ForgotMailInput placeholder='E-Posta Adresinizi Giriniz' keyboardType='email-address' />
      </ForgotMailBox>
